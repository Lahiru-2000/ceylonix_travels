...
const DestinationDiscoveries = ({ posts }) => {
  return (
    <section style={{ background: "#060A24", padding: "0 0 95px" }}>
      <div className="ceylon-container">
        <span className="ceylon-subtitle">Travel Blog</span>
        ...
        <p style={{ color: "rgba(255,255,255,0.67)", marginBottom: "24px", fontSize: "14px" }}>
          Explore storytelling, guides, and practical tips for your next adventure.
        </p>
          ...
          {posts.map((post, index) => (
            <div className="col-md-6 col-xl-3" key={`${post.title}-${index}`}>
              <article>
                ...
                <span style={{ fontSize: "13px", color: "#FC0FC0", fontWeight: 600 }}>Read More</span>
              </article>
            </div>
          ))}
        </div>
